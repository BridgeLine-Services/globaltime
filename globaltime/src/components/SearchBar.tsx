  ...
  return (
    <div className="relative w-full max-w-2xl">
      <div className={`flex items-center gap-3 px-4 py-3 rounded-2xl border transition-all duration-300 bg-white/5 backdrop-blur-md ${
        ...
        />
        {query && (
          <button onClick={() => setQuery('')} aria-label="Clear search" className="min-h-11 min-w-11 flex items-center justify-center text-white/40 hover:text-white transition-colors">
            <X size={16} />
          </button>
        )}
      </div>
